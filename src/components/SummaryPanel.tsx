      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-semibold tracking-wide" style={{ color: 'var(--text-secondary)' }}>
            {t('summary.title')}
            {hasMarketData && <span style={{ color: 'var(--text-muted)' }} className="font-normal ml-1.5">· {t('summary.market')}</span>}
            {hasSwarm && <span style={{ color: 'var(--accent)' }} className="font-normal ml-1.5">· {t('summary.multiAgent')}</span>}
          </span>
        </div>
